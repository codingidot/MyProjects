...
public class QnaWrite implements QnaImpl{
	...
	public void qna(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("repalce한 content : " + content);
		...
		int writecheck = qdao.qnaWrite(no, id,pno,title,content,pw,fileName,category);
