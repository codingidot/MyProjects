...
<br><br>
        ...
        <div class ="container">
            <form id ="form_data" action="qnawrite.do" method="post" enctype="multipart/form-data">
                <table class ="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td>내용</td>
							<td><textarea rows="10" cols="10" name = "content" onkeypress="CheckLength();" class="form-control" 
